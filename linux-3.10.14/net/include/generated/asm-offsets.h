...
#define TASK_MM 172 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 212 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1144 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 464 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 468 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 472 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 476 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 480 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 484 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 488 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 492 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 496 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 500 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 504 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 508 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_FPU 512 /* offsetof(struct task_struct, thread.fpu)	 # */
#define THREAD_BVADDR 828 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 832 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 836 /* offsetof(struct task_struct, thread.error_code)	 # */

#define THREAD_FPR0 512 /* offsetof(struct task_struct, thread.fpu.fpr[0])	 # */
#define THREAD_FPR1 520 /* offsetof(struct task_struct, thread.fpu.fpr[1])	 # */
#define THREAD_FPR2 528 /* offsetof(struct task_struct, thread.fpu.fpr[2])	 # */
#define THREAD_FPR3 536 /* offsetof(struct task_struct, thread.fpu.fpr[3])	 # */
#define THREAD_FPR4 544 /* offsetof(struct task_struct, thread.fpu.fpr[4])	 # */
#define THREAD_FPR5 552 /* offsetof(struct task_struct, thread.fpu.fpr[5])	 # */
#define THREAD_FPR6 560 /* offsetof(struct task_struct, thread.fpu.fpr[6])	 # */
#define THREAD_FPR7 568 /* offsetof(struct task_struct, thread.fpu.fpr[7])	 # */
#define THREAD_FPR8 576 /* offsetof(struct task_struct, thread.fpu.fpr[8])	 # */
#define THREAD_FPR9 584 /* offsetof(struct task_struct, thread.fpu.fpr[9])	 # */
#define THREAD_FPR10 592 /* offsetof(struct task_struct, thread.fpu.fpr[10])	 # */
#define THREAD_FPR11 600 /* offsetof(struct task_struct, thread.fpu.fpr[11])	 # */
#define THREAD_FPR12 608 /* offsetof(struct task_struct, thread.fpu.fpr[12])	 # */
#define THREAD_FPR13 616 /* offsetof(struct task_struct, thread.fpu.fpr[13])	 # */
#define THREAD_FPR14 624 /* offsetof(struct task_struct, thread.fpu.fpr[14])	 # */
#define THREAD_FPR15 632 /* offsetof(struct task_struct, thread.fpu.fpr[15])	 # */
#define THREAD_FPR16 640 /* offsetof(struct task_struct, thread.fpu.fpr[16])	 # */
#define THREAD_FPR17 648 /* offsetof(struct task_struct, thread.fpu.fpr[17])	 # */
#define THREAD_FPR18 656 /* offsetof(struct task_struct, thread.fpu.fpr[18])	 # */
#define THREAD_FPR19 664 /* offsetof(struct task_struct, thread.fpu.fpr[19])	 # */
#define THREAD_FPR20 672 /* offsetof(struct task_struct, thread.fpu.fpr[20])	 # */
#define THREAD_FPR21 680 /* offsetof(struct task_struct, thread.fpu.fpr[21])	 # */
#define THREAD_FPR22 688 /* offsetof(struct task_struct, thread.fpu.fpr[22])	 # */
#define THREAD_FPR23 696 /* offsetof(struct task_struct, thread.fpu.fpr[23])	 # */
#define THREAD_FPR24 704 /* offsetof(struct task_struct, thread.fpu.fpr[24])	 # */
#define THREAD_FPR25 712 /* offsetof(struct task_struct, thread.fpu.fpr[25])	 # */
#define THREAD_FPR26 720 /* offsetof(struct task_struct, thread.fpu.fpr[26])	 # */
#define THREAD_FPR27 728 /* offsetof(struct task_struct, thread.fpu.fpr[27])	 # */
#define THREAD_FPR28 736 /* offsetof(struct task_struct, thread.fpu.fpr[28])	 # */
#define THREAD_FPR29 744 /* offsetof(struct task_struct, thread.fpu.fpr[29])	 # */
#define THREAD_FPR30 752 /* offsetof(struct task_struct, thread.fpu.fpr[30])	 # */
#define THREAD_FPR31 760 /* offsetof(struct task_struct, thread.fpu.fpr[31])	 # */
#define THREAD_FCR31 768 /* offsetof(struct task_struct, thread.fpu.fcr31)	 # */
...
#define VCPU_ARCH_SIZE 3312 /* sizeof(struct kvm_vcpu_arch)	 # */
