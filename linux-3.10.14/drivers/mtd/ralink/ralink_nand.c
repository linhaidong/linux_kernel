...
#define NAND_MTD_BOOT_PART_SIZE		(0x20000 * 4)
#define NAND_MTD_CONFIG_PART_SIZE	(0x20000 * 4)
#define NAND_MTD_FACTORY_PART_SIZE	(0x20000 * 2)

#ifdef  CONFIG_RT2880_ROOTFS_IN_FLASH
#define NAND_MTD_KERN_PART_SIZE		CONFIG_MTD_KERNEL_PART_SIZ
#define NAND_MTD_ROOTFS_PART_SIZE (IMAGE1_SIZE - (NAND_MTD_BOOT_PART_SIZE +  NAND_MTD_CONFIG_PART_SIZE + NAND_MTD_FACTORY_PART_SIZE + CONFIG_MTD_KERNEL_PART_SIZ))
#define NAND_MTD_ROOTFS_PARTITION_NO		5
#else
#define NAND_MTD_KERN_PART_SIZE	(IMAGE1_SIZE - (NAND_MTD_BOOT_PART_SIZE +  NAND_MTD_CONFIG_PART_SIZE + NAND_MTD_FACTORY_PART_SIZE))
#endif
...
#define BMT_APPLY_START_OFFSET	FILE_SYSTEM_START_ADDRESS
	...
	/* Put your own partition definitions here */
        {
                ...
                name:           "Kernel",
                size:           NAND_MTD_KERN_PART_SIZE,
                offset:         MTDPART_OFS_APPEND,
        }, {
                name:           "RootFS",
                size:           NAND_MTD_ROOTFS_PART_SIZE,
                offset:         MTDPART_OFS_APPEND,
#ifdef CONFIG_ROOTFS_IN_FLASH_NO_PADDING
        }, {
                name:           "Kernel_RootFS",
                size:           NAND_MTD_KERN_PART_SIZE + NAND_MTD_ROOTFS_PART_SIZE,
                offset:         NAND_MTD_BOOT_PART_SIZE + NAND_MTD_CONFIG_PART_SIZE + NAND_MTD_FACTORY_PART_SIZE,
#endif
...
static int nfc_all_reset(void)
{
	...
	//ra_outl(NFC_CTRL, ra_inl(NFC_CTRL) & ~(0xfff0)); //clear timeing
	//ra_outl(NFC_CTRL, ra_inl(NFC_CTRL) | 0x1410); //set timeing
...
//ranfc_mtd->numberaseregions
...
#ifdef CONFIG_ROOTFS_IN_FLASH_NO_PADDING
	offs = NAND_MTD_BOOT_PART_SIZE + NAND_MTD_CONFIG_PART_SIZE + NAND_MTD_FACTORY_PART_SIZE;
	...
	if (hdr.ih_ksz != 0) {
		...
		rt2880_partitions[5].size = IMAGE1_SIZE - (NAND_MTD_BOOT_PART_SIZE +
				NAND_MTD_CONFIG_PART_SIZE + NAND_MTD_FACTORY_PART_SIZE +
				ntohl(hdr.ih_ksz));
	}
#endif
	...
	rt2880_partitions[5].offset = IMAGE1_SIZE + (NAND_MTD_BOOT_PART_SIZE + NAND_MTD_CONFIG_PART_SIZE \
					+ NAND_MTD_FACTORY_PART_SIZE);
#ifdef CONFIG_RT2880_ROOTFS_IN_FLASH
